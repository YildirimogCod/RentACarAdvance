...
namespace Core.Security.Entities
{
    public class User:Entity<int>
    {
        ...
        public bool Status { get; set; } // true: active, false: passive
        ...
        public User(int id, string firstName, string lastName, string email, byte[] passwordHash, byte[] passwordSalt, bool status) : base(id)
        {
            FirstName = firstName;
            LastName = lastName;
            Email = email;
